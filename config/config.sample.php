...
// Determine application base path (works in subfolder on localhost and root on production)
if (!defined('BASE_PATH')) {
    ...
    // Ensure leading slash, normalize root to empty string for convenience
